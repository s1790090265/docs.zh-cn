...
- [Spark connetor](../loading/Spark-connector-starrocks.md)可以通过 Spark 导入数据至 StarRocks。相较于 [Spark Load](../loading/SparkLoad.md)，Spark connetor 能力更完善。由您自定义 Spark 作业，对数据进行 ETL 操作，Spark connector 只作为 Spark 作业中的 sink。
